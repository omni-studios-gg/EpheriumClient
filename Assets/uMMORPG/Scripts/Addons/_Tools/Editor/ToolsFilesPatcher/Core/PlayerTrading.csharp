...
namespace uMMORPG
{
    ...
    public partial class PlayerTrading : NetworkBehaviour
    {
        [Header("Components")]
...
#if _iMMOSETTINGS
            && !((Player)entity).playerAddonsConfigurator.isBlockingTrade;
#else
                ;
#endif
        }
...
#if _iMMOITEMLEVELUP
            player.inventory.CheckResetEquipmentLevelUp(inventory.slots[slotIndices[0]].item);
#endif
            }
        }
