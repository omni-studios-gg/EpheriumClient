...
namespace uMMORPG
{
    public static class GuildSystem
    {
        ...
        public static bool CreateGuild(int creatorId, string creator, int creatorLevel, string guildName)
        {
            // doesn't exist yet?
                ...
                !Database.singleton.GuildExists(guildName)) // db check only on server, no Guild.CanCreate function because client has no DB.
            {
                ...
                Guild guild = new Guild(guildName, creatorId, creator, creatorLevel);
        ...
        public static bool AddToGuild(string guildName, string requester, int memberId, string member, int memberLevel)
        {
                ...
                guild.CanInvite(requester, member))
            {
                ...
                guild.members[guild.members.Length - 1] = new GuildMember(memberId, member, memberLevel, true, GuildRank.Member);
