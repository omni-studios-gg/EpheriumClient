...
namespace uMMORPG
{
    ...
    public class PlayerPetControl : NetworkBehaviour
    {
        ...
        [SyncVar, HideInInspector] public bool isSkillPet;
        ...
        // -> we offset the positionPlaceableObject by exactly 1 x bounds to the left because dogs
        ...
        public void OnKilledEnemy(Entity victim)
        {
            ...
            if (victim is Monster monster)
            {
                ...
                if (activePet != null && isSkillPet == false)
                {
