    ...
    public partial class UILoot : MonoBehaviour
    {
        ...
        void Update()
        {
                ...
                monster.inventory.HasLoot())
            {
                ...
                // might accidentally click on the same slot at the same TimeLogout, and
...
#if _iMMOTOOLS
                        if (itemSlot.item.data.dropSound)
                            player.audioSource.PlayOneShot(itemSlot.item.data.dropSound, 1);
#endif
                        });
