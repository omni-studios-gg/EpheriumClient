...
namespace uMMORPG
{
    ...
    public class PlayerNavMeshMovement : NavMeshMovement
    {
        ...
        void UpdateAnimations()
        {
            ...
            {
                animator.SetFloat("DirZ", agent.velocity.magnitude, directionDampening, Time.deltaTime); // smooth idle<->run transitions
                animator.SetBool("OnGround", true); //player.mountControl.activeMount == null);
            }
        }
        ...
        void LateUpdate()
        {
            ...
            // LateUpdate() is sometimes called before OnStartLocalPlayer.
